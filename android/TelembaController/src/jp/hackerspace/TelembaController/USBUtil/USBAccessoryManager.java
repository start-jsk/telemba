/********************************************************************
 ...
 supplied to you, the Company?ｽs customer, for use solely and
 ...
 THIS SOFTWARE IS PROVIDED IN AN ?ｽAS IS?ｽ CONDITION. NO WARRANTIES,
...
//							.openAccessory(accessory);
	...
	public void disable(Context context) {
		System.out.println( "usb disable" ) ;
	...
	private class ReadThread extends Thread {
		...
		public void run() {
			...
			while (continueRunning) {
				try {
					if ( System.currentTimeMillis() - TelembaActivity.timer > 3000 ){
						Log.d(TAG,"invalid timer") ;
						break ;
					} else {
						Log.d(TAG,"running") ;
					}
